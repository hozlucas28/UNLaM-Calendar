...
if command -v golangci-lint > /dev/null 2>&1; then
	printf "\e[32m- Golangci-lint $(command_version golangci-lint version) installed.\e[0m\n"
else
	printf "\e[33m- Golangci-lint is not installed or not found in PATH.\e[0m\n" >&2
	exit_code=1
fi

if command -v gitleaks > /dev/null 2>&1; then
	printf "\e[32m- Gitleaks $(command_version gitleaks --version) installed.\e[0m\n"
else
	printf "\e[31m- Gitleaks is not installed or not found in PATH.\e[0m\n" >&2
	exit_code=1
fi

if command -v renovate > /dev/null 2>&1; then
	printf "\e[32m- Renovate $(command_version act --version) installed.\e[0m\n"
else
	printf "\e[31m- Renovate is not installed or not found in PATH.\e[0m\n" >&2
	exit_code=1
fi

if command -v act > /dev/null 2>&1; then
	printf "\e[32m- act $(command_version act --version) installed.\e[0m\n"
else
	printf "\e[31m- act is not installed or not found in PATH.\e[0m\n" >&2
	exit_code=1
fi
...
if [[ "$env" == 'local' ]]; then
	if command -v jq > /dev/null 2>&1; then
		printf "\e[32m- jq $(command_version jq --version) installed.\e[0m\n"
	else
		printf "\e[31m- jq is not installed or not found in PATH.\e[0m\n" >&2
		exit_code=1
	fi
fi
...
if version=$(command_version bun run prettier --version); then
	printf "\e[32m- Prettier $version installed.\e[0m\n"
else
	printf "\e[31m- Prettier is not installed.\e[0m\n" >&2
	exit_code=1
fi

if version=$(command_version bun run biome --version); then
	printf "\e[32m- Biome $version installed.\e[0m\n"
else
	printf "\e[31m- Biome is not installed.\e[0m\n" >&2
	exit_code=1
fi

if version=$(command_version bun run lefthook --version); then
	printf "\e[32m- Lefthook $version installed.\e[0m\n"
else
